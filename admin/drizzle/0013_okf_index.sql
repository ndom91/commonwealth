-- Mirrors db/migrations/0011_okf_index.sql. The MCP and admin services will
-- both read the commit-pinned index after the OKF cutover, so it belongs in both
-- migration chains while the old source tables remain live.
