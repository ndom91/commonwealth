      ...
      <form className="intake__form" onSubmit={submit}>
        <div>
          ...
          {/* The role is stated before the password is chosen, not discovered
              ...
              The project, for the same reason: an instance holds several
              ...
              typed alongside it. */}
          <p className="prose">
            {invitation.invitedBy} invited <b>{invitation.email}</b> to <b>{invitation.project}</b>{' '}
            as <b>{role}</b> — {ROLE_SUMMARY[role].toLowerCase()}. Pick a password; nobody else will
